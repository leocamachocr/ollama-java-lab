...
---
## Contexto extendido
Para sesiones de documentación compleja, adjuntá:
- `#file:shared/AGENT_CORE.md` — contexto completo del agente
- `#file:<documento relevante>` — documento que querés revisar o continuar
